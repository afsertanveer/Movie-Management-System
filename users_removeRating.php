...
<body>
  ...
  <section class="contact-us" style="height: 1420px;">
    <?php
    $sql = pg_query($db, "select * from film,ratingfilm where film.f_id = ratingfilm.f_id and ratingfilm.u_id='$user_id'");
    ...
    ?>
       <tr style="background-color:#a12c2f; vertical-align:top; border:1px solid white; height: 70px;">
            ...
            <td style="border:1px solid white" ><a href="users_deleteRatings.php?dfid=<?php echo $dfid;?>">Delete</a></td>
       </tr>
   <?php }  } ?>
   </table>
  </section>
