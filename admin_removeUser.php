...
<body>
  ...
  ?>
   ...
   <section class="contact-us" style="height: 1420px;">
	         ...
	         <div class="col-lg-9 align-self-center">
	         	<div class="row">
	            	<div class="col-lg-12"  style="margin-top: 10%; margin-left: 25%;">
                     <h2 style=" text-align: center; color:white">Delete from User list</h2>
	...
	<?php 
		$sql = pg_query($db, "select * from users where role=2");
	?>
	<?php 
	...
	?>
                     <tr style="background-color:#a12c2f; vertical-align:top; border:1px solid white;">
                        ...
                        <td style="border:1px solid white" ><a href="deleteuser.php?duid=<?php echo $duid;?>">Delete</a></td>
                     </tr>
   <?php    } ?>
                  </table>
               </div>
